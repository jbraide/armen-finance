"""
Django settings for armenfinance project.
...
ROOT_URLCONF = 'armenfinance.urls'
...
WSGI_APPLICATION = 'armenfinance.wsgi.application'
...
MESSAGE_TAGS = {
    ...
    messages.ERROR: 'text-danger alert-danger',
}